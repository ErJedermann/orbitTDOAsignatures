...
if __name__ == '__main__':
    ...
    if ir_sats:
        ...
        ben_sig.add_SignalSource(iridium_source, 10000)
        ...
        ben_sig.add_SignalSource(leo_no_ir_source, 10000)
        valid_sats_tle = TLEcalculator(iridium_tle_file)
    else:
        folder_path = "./data/experiment2/starlink/"
        ...
        ben_sig.add_SignalSource(starlink_source, 10000)
